package me.iris.ambien.obfuscator.transformers.impl.miscellaneous;
...
@TransformerInfo(
        ...
        description = "Adds arts to end of class."
)
public class Ahegao extends Transformer {
    ...
    public void transform(JarWrapper wrapper) {
        if(!(copyPastesFile.getValue().length() < 1)) {
	        try {
		        ahegaos = StringUtil.readCopyPastes(copyPastesFile.getValue());
	        } catch (IOException e) {
		        Ambien.logger.error("Error occurred while reading copy-paste-file!");
	        }
        } else{
            Ambien.logger.info("Using the built-in ahegao dictionary...");
        }
...
// java.lang.IllegalArgumentException: bound must be positive
        ...
        MethodNode clinit = Myj2cASMUtils.findOrCreateClinit(classNode);
